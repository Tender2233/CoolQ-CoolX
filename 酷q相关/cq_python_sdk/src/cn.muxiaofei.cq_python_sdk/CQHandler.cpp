...
class CQMutex
{
	HANDLE m_hMutex;
public:
	CQMutex(LPCTSTR lpName)
	{
		this->m_hMutex = ::CreateMutex(NULL, FALSE, lpName);
	}
	~CQMutex()
	{
...
public:
	CQMutex_SDK()
		: m_Mutex(__SDK_MUTEX_NAME__.c_str())
	{
		m_Mutex.Lock();
	}
	~CQMutex_SDK()
...
public:
	CQMutex_Event()
		: m_Mutex(__EVT_MUTEX_NAME__.c_str())
	{
		m_Mutex.Lock();
	}
	~CQMutex_Event()
...
//////////////////////////////////////////////////////////////////////////
class CQHandler_Base : public I_CQHandler
{

};

class CQHandler_PYTHON27 : public CQHandler_Base
{
	bool m_IsEnabled;
	int32_t m_AuthCode;
	PyObject* m_PyHandler;
public:
	CQHandler_PYTHON27(int32_t AuthCode)
		: m_IsEnabled(false)
		, m_AuthCode(AuthCode)
		, m_PyHandler(NULL)
	{
...
public:
	virtual int32_t OnEvent_Startup() 
	{
		CQMutex_Event __lock__;

		return 0;
	}

	virtual int32_t OnEvent_Exit() 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Enable() 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Disable() 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_PrivateMsg(int32_t subType, int32_t sendTime, int64_t fromQQ, const char *msg, int32_t font) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_GroupMsg(int32_t subType, int32_t sendTime, int64_t fromGroup, int64_t fromQQ, const char *fromAnonymous, const char *msg, int32_t font) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_DiscussMsg(int32_t subType, int32_t sendTime, int64_t fromDiscuss, int64_t fromQQ, const char *msg, int32_t font) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_System_GroupAdmin(int32_t subType, int32_t sendTime, int64_t fromGroup, int64_t beingOperateQQ) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_System_GroupMemberDecrease(int32_t subType, int32_t sendTime, int64_t fromGroup, int64_t fromQQ, int64_t beingOperateQQ) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_System_GroupMemberIncrease(int32_t subType, int32_t sendTime, int64_t fromGroup, int64_t fromQQ, int64_t beingOperateQQ) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Friend_Add(int32_t subType, int32_t sendTime, int64_t fromQQ) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Request_AddFriend(int32_t subType, int32_t sendTime, int64_t fromQQ, const char *msg, const char *responseFlag) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Request_AddGroup(int32_t subType, int32_t sendTime, int64_t fromGroup, int64_t fromQQ, const char *msg, const char *responseFlag) 
	{
		CQMutex_Event __lock__;
	...
	virtual int32_t OnEvent_Menu(const char* index) 
	{
		CQMutex_Event __lock__;
	...
	virtual bool OnEvent_ReInit()
	{
		CQMutex_SDK __sdk_lock__;
		CQMutex_Event __evt_lock__;
...
{
	return std::make_shared<CQHandler_PYTHON27>(AuthCode);
}
